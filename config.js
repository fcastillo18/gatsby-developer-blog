module.exports = {
  pathPrefix: '/gatsby-developer-blog',
  siteUrl: 'https://franklincastillo.dev',
  siteTitle: 'Franklin Castillo',
  siteDescription: 'Just a blog of a software developer',
  author: 'fcastillo18',
  postsForArchivePage: 3,
  defaultLanguage: 'en',
  disqusScript: 'https://franklincastillo-dev.disqus.com/embed.js',
  pages: {
    home: '/',
    blog: 'blog',
    about: 'about',
  ...
  social: {
    github: 'https://github.com/fcastillo18',
    linkedin: '',
    rss: '/rss.xml',
  },
  tags: {
